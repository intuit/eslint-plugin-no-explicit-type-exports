...
ruleTester.run('no-explicit-type-exports', rule, {
  valid: [
    ...
    {
      // The rule passes when export an interface on a single line that was already inline exported
      filename: fileName,
      code: "import type { Bar } from './barInterface';export type {Bar}",
    },
    {
      // The rule passes when export an interface on a single line that was already inline exported
      filename: fileName,
      code: "export type { Bar } from './barInterface'",
    },
    {
      // The rule passes when export a class on a single line that was already inline exported
      filename: fileName,
      code: "export { Thud } from './barInterface'",
    },
    {
      // The rule passes when export a const on a single line that was already inline exported
      filename: fileName,
      code: "export { qux } from './barInterface'",
    },
    {
      // The rule passes when export an interface on a single line that was already inline exported
      // Another module level up
      filename: fileName,
      code: "import type { Bar } from './bazInterface';export type {Bar}",
    },
    {
      // The rule passes when export an interface on a single line that was already inline exported
      // Another module level up
      filename: fileName,
      code: "export type { Bar } from './bazInterface'",
    },
    {
      // The rule passes when export a class on a single line that was already inline exported
      // Another module level up
      filename: fileName,
      code: "export { Thud } from './bazInterface'",
    },
    {
      // The rule passes when export a const on a single line that was already inline exported
      // Another module level up
      filename: fileName,
      code: "export { qux } from './bazInterface'",
    },
    {
  ...
  invalid: [
    ...
    {
      // The rule fails when export an interface on a single line
      filename: fileName,
      code: "export { Bar } from './bar'",
      output: "export type { Bar } from './bar';\n",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
    ...
    {
      // The rule fails when export an interface on a single line that was already inline exported
      filename: fileName,
      code: "import { Bar } from './barInterface';export {Bar}",
      output: "import type { Bar } from './barInterface';\nexport type { Bar }",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
    ...
    },
    {
      // The rule fails when export an interface on a single line that was already inline exported
      filename: fileName,
      code: "export { Bar } from './barInterface'",
      output: "export type { Bar } from './barInterface';\n",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
    ...
    {
      // The rule fails when export an interface on a single line that was already inline exported
      // And export an inline exported class
      filename: fileName,
      code: "export { Bar, Thud } from './barInterface'",
      output:
        "export type { Bar } from './barInterface';\nexport { Thud } from './barInterface';",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
    ...
    {
      // The rule fails when export an interface on a single line that was already inline exported
      // And export an inline exported const
      filename: fileName,
      code: "export { Bar, qux } from './barInterface'",
      output:
        "export type { Bar } from './barInterface';\nexport { qux } from './barInterface';",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
    ...
    },
    {
      // The rule fails when export an interface on a single line that was already inline exported
      filename: fileName,
      code: "export { Bar as FooBar } from './barInterface'",
      output: "export type { Bar as FooBar } from './barInterface';\n",
      errors: [
        {
          message: "Do not export 'Bar' it is an imported type or interface.",
        },
